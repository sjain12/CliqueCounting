#ifndef ESCAPE_CLIQUES_EDGE_SAMPLING_1_H_
#define ESCAPE_CLIQUES_EDGE_SAMPLING_1_H_
...
void cliques_edge_sampling_1(CGraph &CG, CDAG &DG, ofstream &of, string gname, string fname, unsigned long long clique_size, float p)
{    
