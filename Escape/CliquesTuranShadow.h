...
void turan_shadow(CGraph &CG, CDAG &DG, ofstream &of, string gname, string fname, int runs, int num_samples, int clique_size)
{    
    ...
    string datfile(gname + "_" + to_string(num_samples) + "_" + to_string(clique_size) + "_" + to_string(runs) + "_data");
    ...
    string outfile(gname + "_" + to_string(num_samples) + "_" + to_string(clique_size) + "_params");
