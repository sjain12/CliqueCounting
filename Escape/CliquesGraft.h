#ifndef ESCAPE_CLIQUES_EDGE_SAMPLING_2_H_
#define ESCAPE_CLIQUES_EDGE_SAMPLING_2_H_
...
void cliques_edge_sampling_2(Graph &g, CGraph &CG, CDAG &DG, ofstream &of, string gname, string fname, unsigned long long clique_size, int num_samples)
{    
